...
- Prefer isolated `context_bundle` delegation over full `current_workspace` delegation. Context bundles must contain only explicitly approved relative files and must be prepared locally before any API call.
